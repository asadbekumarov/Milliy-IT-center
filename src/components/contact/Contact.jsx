      ...
      <div className="max-w-[1460px] mx-auto px-4 py-4">
        <div className="flex flex-col lg:flex-row justify-between gap-10 py-10">
          <div className="flex-1">
            <h4 className="bg-[#539c9f] inline-block p-1 font-swiss text-white font-bold text-lg">
              Biz bilan bog'lanish
            </h4>
            <h2 className="font-semibold text-4xl sm:text-5xl md:text-6xl text-black my-7">
              Bepul konsultatsiya
            </h2>
            <p className="text-lg md:text-xl mb-5 text-black max-w-[717px]">
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2 text-base md:text-xl font-swiss text-black">
                <BsCheckLg />
          ...
          <div className="bg-white p-5 rounded-md w-full max-w-2xl mx-auto shadow-md flex-1">
            <h3 className="font-semibold text-2xl font-swiss mb-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col md:flex-row items-stretch gap-4">
                ...
                <div className="flex gap-2 items-end">
                  <button className="bg-[#e5f3f4] p-2 rounded-md">
                    asdfgh
                  </button>
                  <button className="w-[60px] h-[48px] flex items-center justify-center rounded-lg bg-[#539c9f] hover:bg-[#3c7f82] transition">
                    <FaArrowsRotate className="text-white" />
                  </button>
                </div>
              </div>

              <button className="bg-[#539c9f] text-white w-full py-2 mt-2 rounded-md font-semibold text-xl hover:bg-[#3c7f82] transition">
                Yuborish
              </button>
            </div>
          </div>
